 ...
 * code runs inside a cart validation Function, in the admin, and — when the
...
describe("order limits stay portable", () => {
  ...
  /**
   * A limit that blocks a cart at 23:59 and lets it through at 00:01 would be
   * one nobody could explain. Everything comes in through the arguments.
   */
