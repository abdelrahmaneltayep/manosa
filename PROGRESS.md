...
Updated: 2026-09-18T21:30:00Z
Current milestone: 6 — Analytics
Current task: the pricing P2s from the 1.1-1.2 cold read [done]. The billing
P2s (`qa/0.3/COLD-READ.md` #2, #3, #4, #5, #7) and the tenancy P2-8
(`qa/0.1/COLD-READ.md` — three docs that no longer describe the code, and an
isolation test that probes only the one model with no relations) are next.
