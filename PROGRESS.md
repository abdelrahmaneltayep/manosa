...
Updated: 2026-09-18T23:10:00Z
Current milestone: 6 — Analytics
Current task: the billing P2s from the 0.3 cold read [done]. The tenancy P2-8
(`qa/0.1/COLD-READ.md` — three docs that no longer describe the code, and an
isolation test that probes only the one model with no relations) is next, and
is the last open P2.
